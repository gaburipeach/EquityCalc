...
class TestShowdown(TestCase):
    ...
    def test_is_pair1(self):
        ...
        self.assertEqual(True, s.is_pair(gen))
    ...
    def test_is_pair3(self):
        # Test if method detects pair from three of a kind
        gen = [Card(2, 1), Card(3, 3), Card(4, 3), Card(4, 4), Card(4, 2)]
        s = Showdown(None, None)
        self.assertEqual(True, s.is_pair(gen))
    ...
    def test_is_two_pair1(self):
        ...
        s = Showdown(None, None)
        self.assertEqual(True, s.is_two_pair(gen))
    ...
    def test_is_two_pair3(self):
        ...
        gen = [Card(14, 3), Card(14, 2), Card(14, 1), Card(14, 4), Card(13, 3)]
        s = Showdown(None, None)
        self.assertEqual(True, s.is_two_pair(gen))
    ...
    def test_is_three_kind(self):
        ...
        s = Showdown(None, None)
        self.assertEqual(True, s.is_three_kind(gen))

    def test_is_three_kind2(self):
        # Test if method detects no three of a kind
        gen = [Card(1, 3), Card(14, 2), Card(14, 1), Card(13, 4), Card(12, 3)]
        s = Showdown(None, None)
    ...
    def test_is_straight1(self):
        ...
        s = Showdown(None, None)
        self.assertEqual(True, s.is_straight(gen))
    ...
    def test_is_flush(self):
        ...
        s = Showdown(None, None)
        self.assertEqual(True, s.is_flush(gen))
    ...
    def test_is_full_house(self):
        gen = [Card(5, 2), Card(5, 3), Card(14, 3), Card(14, 2), Card(14, 4)]
        s = Showdown(None, None)
        self.assertEqual(True, s.is_full_house(gen))
    ...
    def test_is_full_house3(self):
        ...
        gen = [Card(5, 2), Card(5, 3), Card(5, 1), Card(5, 4), Card(14, 4)]
        s = Showdown(None, None)
        self.assertEqual(False, s.is_full_house(gen))
    ...
    def test_is_four_kind(self):
        ...
        gen = [Card(14, 3), Card(14, 2), Card(14, 1), Card(14, 4), Card(12, 3)]
        s = Showdown(None, None)
        self.assertEqual(True, s.is_four_kind(gen))
